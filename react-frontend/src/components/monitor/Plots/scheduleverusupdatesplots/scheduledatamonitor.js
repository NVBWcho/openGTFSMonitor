...
import { getHourlyScheduleUpdateData } from "../../../../services/micromonitorcalls";





export const ScheduleDataMonitor = () => {
    ...
    useEffect(() => {
        ...
        const fetchGtfsData = async () => {
            ...
            const res_hourly=await getHourlyScheduleUpdateData()
            //(res_nvbw.data)
            //console.log(res_nvbw.data[0])

            //console.log(res_hourly)
            const data = res_hourly.data
            console.log("hello")
    ...
    return (
        <div className="container">
            ...
            <div className="row mt-2 mb-2">
                <AgencyWiseMonitor></AgencyWiseMonitor>
            </div>
